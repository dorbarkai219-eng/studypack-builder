  ...
  blocks: [
    {
      ...
      rubric: {
        mustContain: [
          "כתיבת המשוואה Equity = EV + Excess Cash − Net Debt לפני שמשבצים מספרים.",
          "הצהרה מפורשת איזה מספר נתון הוא EV ואיזה Equity (כדי לא לחבר תפוחים ותפוזים).",
          "שימוש ב-Net Debt (לא חוב ברוטו) אם הנתון הוא נטו, או הסבר מדוע ההפך.",
          "תוצאה מספרית עם יחידות (₪ או $) ובדיקת סבירות מול שווי שוק אם נתון.",
        ],
        topTrap: "להשתמש בחוב ברוטו במקום בחוב נטו כשהנתון 'Net Debt' כבר ניתן בשאלה.",
        notes: [
          "הצורה ההפוכה EV = Equity + Net Debt − Excess Cash שימושית כשמתחילים משווי שוק של המניה.",
        ],
      },
      practiceItems: [
        {
          id: "A-1",
          title: "שאלה 4, מבחן 2024",
          prompt:
            "חברה X מציגה: EV = 1,800 מיליון ₪, מזומן עודף = 220 מיליון ₪, חוב פיננסי = 650 מיליון ₪. חשב את שווי ההון של בעלי המניות. הסבר מהו Net Debt במקרה זה והאם המעבר EV→Equity נדרש או שמותר להשתמש ב-EV ישירות.",
          referenceSolution:
            "Net Debt = 650 − 220 = 430. Equity = EV + Excess Cash − Net Debt = 1,800 + 220 − 430 = 1,590 מיליון ₪. שווי המניות הוא 1,590 מיליון ₪. המעבר חיוני: EV מתאר את שווי הפעילות ולא שייך לבעלי המניות לבדם.",
          sourceRef: "src2 עמ׳ 4",
        },
        {
          id: "A-2",
          title: "תרגול עצמי",
          prompt:
            "חברה Y: שווי שוק של המניה = 950, חוב נטו = 300. חשב EV. הסבר באיזה כיוון השתמשת בגשר.",
          sourceRef: "src3 עמ׳ 11",
        },
      ],
    },
    {
